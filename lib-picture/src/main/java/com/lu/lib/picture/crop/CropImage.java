...
public final class CropImage {
  ...
  public static final class ActivityBuilder {
    ...
    public void start(@NonNull Activity activity, @Nullable Class<?> cls) {
      ...
      activity.startActivityForResult(getIntent(activity, cls), CROP_IMAGE_ACTIVITY_REQUEST_CODE, options.toBundle());
    }
    ...
    public ActivityBuilder setSelected(boolean selected){
      mOptions.selected = selected;
      return this;
    }
  }
  // endregion
